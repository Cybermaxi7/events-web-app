      ...
      <section className="bg-primary-50 bg-dotted-pattern bg-contain py-5 md:py-10">
        <div className="wrapper grid grid-cols-1 gap-5 md:grid-cols-2 2xl:gap-0">
          <div className="flex-col flex justify-center gap-8">
            ...
            Host, Connect, and Celebrate: Your Events, Our Expertise!
            </h1>
            <p className="p-regular-20 md:p-regular-24">
            Discover and gain insights from 3,392+ mentors at top-tier companies through our worldwide communities.
            </p>
